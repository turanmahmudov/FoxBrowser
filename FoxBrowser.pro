...
UBUNTU_TRANSLATION_DOMAIN="foxbrowser.turan-mahmudov-l"
...
aptest.commands = bash $$PWD/FoxBrowser/tests/autopilot/run
aptest.depends  = sub-FoxBrowser

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/FoxBrowser/tests/unit
unittest.depends  = sub-FoxBrowser
